...
\begin{tikzpicture}
  ...
  \draw[black, fill] ({cos(45)}, {sin(45)}) circle [radius=0.1];
  \draw[black, fill] ({cos(100)}, {sin(100)}) circle [radius=0.1];
  \draw[black, fill] ({cos(170)}, {sin(170)}) circle [radius=0.1];
  \draw[black, fill] ({cos(200)}, {sin(200)}) circle [radius=0.1];
